        ...
        child: Column(
          ...
          children: [
            ...
            CustomeTextFormField(
              ...
              prefixIcon: HugeIcon(icon: HugeIcons.strokeRoundedUser, color: context.colorScheme.primary),
            ),
            SizedBox(height: 16),
            CustomeTextFormField(
              controller: nameController,
              hintText: 'رقم الهاتف',
              prefixIcon: HugeIcon(icon: HugeIcons.strokeRoundedCall, color: context.colorScheme.primary),
            ...
            CustomeTextFormField(
              ...
              prefixIcon: HugeIcon(icon: HugeIcons.strokeRoundedCircleLock01, color: context.colorScheme.primary),
              obscureText: true,
            ),
            SizedBox(height: 16),
            CustomeTextFormField(
